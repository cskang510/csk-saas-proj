...
// function to handle the submit of the form and intercep the default event
    submitHandler = function (event) {
      var $form = $(event.target);
      // make sure the button is not clicked multiple times
...
// function to handle the token received from Stripe and remove credit card fields
    stripeResponseHandler = function (status, response) {
        ...
        // return false stops the default handler
        return false;
        
    };

    // function to show errors when Strip functionality returns an error
